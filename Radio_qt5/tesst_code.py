...
from my_shazam.my_shazam_api import search_song
...
class Radio(QtWidgets.QWidget):
    def __init__(self, *args, **kwargs):
        ...
        self.playing = None  # Что сейчас играет
        self.added_radio = []
    ...
    def ui_setting(self):
        ...
        self.objectTitleBar.shazam_btn.clicked.connect(self.shazam_act)
    ...
    def play(self):
        if self.play_btn.text() == "Пуск":
            ...
            if self.display.value() in self._def_radio_dic:
                ...
                self.playing = self._def_radio_dic[self.display.value()][0]
                ...
                self.playing = self.added_radio_dic[self.display.value()][0]
                self.playing_radio = True
    ...
    def shazam_act(self):
        print(search_song(r'C:\Users\aarrt17\Desktop\FinalProject\JEldzhejj_-_Boshki_Dymyatsya_(musmore.com).mp3'))
